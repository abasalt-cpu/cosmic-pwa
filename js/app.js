...
const ICON_CALC=`<svg width="34" height="34" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="vertical-align:-11px; margin-inline-end:6px"><path d="M8.7 12c0-1.5 1.15-2.5 2.35-1.75 1.05.65 1.05 2.85 0 3.5-1.2.75-2.35-.25-2.35-1.75Z" fill="currentColor"/><path d="M15.3 12c0-1.5-1.15-2.5-2.35-1.75-1.05.65-1.05 2.85 0 3.5 1.2.75 2.35-.25 2.35-1.75Z" fill="currentColor"/></svg>`;
